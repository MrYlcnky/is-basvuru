    ...
    <nav className="bg-gray-900 text-white px-4 sm:px-6 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-around">
        ...
        <Link to="/" className="flex items-center">
          <img src="/src/images/group.png" alt="Group Logo" className="h-10 w-auto" />
        </Link>

        {/* Masaüstü Menü */}
        <ul className="hidden md:flex items-center gap-10">
          <li>
            <Link to="/" className="hover:underline font-semibold">Anasayfa</Link>
          </li>
          <li className="relative group">
            ...
            <div className="absolute left-0 top-full z-20 w-44 rounded-md bg-gray-900 shadow-lg invisible opacity-0 translate-y-1 transition group-hover:visible group-hover:opacity-100 group-hover:translate-y-0">
              <ul className="py-1">
                <li>
                  <Link to="/JobApplicationForm" className="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-white">Kariyer</Link>
                </li>
                <li>
                  <Link to="/Hakkımızda" className="block px-4 py-2 text-sm text-gray-300 hover:bg-white/5 hover:text-white">Hakkımızda</Link>
                </li>
              </ul>
            </div>
          </li>
          <li>
            <Link to="/Iletisim" className="hover:underline font-semibold">Chamada Club</Link>
          </li>
          <li>
            <Link to="/Iletisim" className="hover:underline font-semibold">İletişim</Link>
          </li>
        </ul>
